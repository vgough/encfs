...
How about a nice email instead?  If you insist, this [Bitcoin](https://bitcoin.org/en/faq) address can be used for donations:

![Bitcoin QR code](http://i.imgur.com/cmqfelm.png)
