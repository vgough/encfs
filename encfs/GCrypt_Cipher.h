...
#ifndef _GCrypt_Cipher_incl_
#define _GCrypt_Cipher_incl_
...
*/
class GCrypt_Cipher : public Cipher {
  Interface iface;
  Interface realIface;
 ...
 public:
  GCrypt_Cipher(const Interface &iface, const Interface &realIface,
             int keyLength, int algo);
  virtual ~GCrypt_Cipher();
